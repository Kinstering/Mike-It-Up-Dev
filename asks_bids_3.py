...
def on_message(ws, message):
    ...
    if os.path.exists('data/asks_3.csv')==False:        total_a_df     = total_a_df[0:0]
    if os.path.exists('data/asks_15m_3.csv')==False:    total_a_df_15m = total_a_df_15m[0:0]
    if os.path.exists('data/asks_4h_3.csv')==False:     total_a_df_4h  = total_a_df_4h[0:0]

    if os.path.exists('data/bids_3.csv')==False:        total_b_df     = total_b_df[0:0]
    if os.path.exists('data/bids_15m_3.csv') == False:  total_b_df_15m = total_b_df_15m[0:0]
    if os.path.exists('data/bids_4h_3.csv') == False:   total_b_df_4h  = total_b_df_4h[0:0]
    ...
    if message.find('depthUpdate') > 0:
        ...
        if was_time != now_time:
            was_time = now_time
            total_a_df.to_csv("data/asks_3.csv", sep=',', mode='a', header=not os.path.exists("data/asks_3.csv"))
            total_a_df_15m.to_csv("data/asks_15m_3.csv", sep=',', mode='a', header=not os.path.exists("data/asks_15m_3.csv"))
            total_a_df_4h.to_csv("data/asks_4h_3.csv", sep=',', mode='a', header=not os.path.exists("data/asks_4h_3.csv"))

            total_b_df.to_csv('data/bids_3.csv', sep=',', mode='a', header=not os.path.exists("data/bids_3.csv"))
            total_b_df_15m.to_csv('data/bids_15m_3.csv', sep=',', mode='a', header=not os.path.exists("data/bids_15m_3.csv"))
            total_b_df_4h.to_csv('data/bids_4h_3.csv', sep=',', mode='a', header=not os.path.exists("data/bids_4h_3.csv"))
